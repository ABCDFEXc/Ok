...
def rndm_bd():
        ...
        with tred(max_workers=30) as Tanim:
                ...
                for love in user:
                        ids = code + love 
                        pasx = [love,ids,ids[:8],ids[:7],'Afghan123','Afghan12345','Afghanistan','10002000','khankhan','900900','800800','khan123','khan12345','afghan123','afghan1234','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸','100200','afghanistan','Afghaniatan','afghanistan123']
